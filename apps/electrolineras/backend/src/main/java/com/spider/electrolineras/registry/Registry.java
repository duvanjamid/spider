package com.spider.electrolineras.registry;
...
public final class Registry {
    ...
    public static void selfRegister() {
        ...
        String name = Env.get("APP_TITLE", "Electrolineras");
        String desc = Env.get("APP_DESCRIPTION", "Mapa de estaciones de carga con estado reportado por la comunidad");
        String icon = Env.get("APP_ICON", "fa-solid fa-charging-station");
        String color = Env.get("APP_COLOR", "#22c55e");
