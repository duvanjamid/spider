package com.spider.alertas.registry;
...
public final class Registry {
    ...
    public static void selfRegister() {
        ...
        String name = Env.get("APP_TITLE", "Alertas");
        String desc = Env.get("APP_DESCRIPTION", "Reportes colaborativos de desastres y peligros en tiempo real");
        String icon = Env.get("APP_ICON", "fa-solid fa-triangle-exclamation");
        String color = Env.get("APP_COLOR", "#ef4444");
